...
@Service
public class FileStoreDOServiceAdapter implements FileStoreDOService {

    protected static final Logger LOGGER = LoggerFactory.getLogger(FileStoreDOServiceAdapter.class);
