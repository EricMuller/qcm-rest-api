...
public class UploadRestController {
    ...
    public Upload uploadFileByType(@PathVariable("fileType") String fileType,
        ...
        return uploadRepository.uploadFile(fileType, multipartFile, async, AuthentificationContextHolder.getPrincipal());
    }
    ...
    public Iterable <Upload> getUploads(@Parameter(hidden = true)
        ...
        return uploadRepository.getUploads(pageable, AuthentificationContextHolder.getPrincipal());
    }
