...
public class JUnitPojoTestGenerator {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        pojoTestGenerator.writePackageTest("qcm-rest-dto", "com.emu.apps.qcm.web.dtos", Version.JUPITER);
        pojoTestGenerator.writePackageTest("qcm-rest-dto", "com.emu.apps.qcm.web.dtos.question", Version.JUPITER);
