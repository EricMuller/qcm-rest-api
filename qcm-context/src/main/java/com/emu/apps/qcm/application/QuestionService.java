...
@Service
public class QuestionService implements ApplicationService {
    ...
    public QuestionService(QuestionRepository questionRepository, QuestionQuery questionQuery, QuestionnaireIdMapper questionnaireIdMapper, TagIdMapper tagIdMapper, @Qualifier("SimpleEventBus") EventBus eventBus) {
    ...
    public Page <QuestionWithTagsOnly> findQuestions(String[] tagUuid,
                                                     String[] questionnaireUuid,
                                                     Pageable pageable, PrincipalId principal) {


        return questionQuery.findQuestionsOfTagIdAndQuestionnaireId(tagIdMapper.toTagId(tagUuid), questionnaireIdMapper.toQuestionnaireId(questionnaireUuid), pageable, principal);
    }
    ...
    public Page <Tag> findAllQuestionTagByPage(Pageable pageable, PrincipalId principal) throws IOException {

        return questionRepository.getTags(StringUtils.EMPTY, pageable, principal);
    }
